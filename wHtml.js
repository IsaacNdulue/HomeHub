                    ...
                    <tr>
                        <td>
                            <div style="padding: 0 2.5em; text-align: center;">
                                <h2 style="font-family: 'Lato', sans-serif; color: rgba(0,0,0,.3); font-size: 40px; margin-bottom: 0; font-weight: 400;">THANK YOU FOR JOINING US</h2>
                                <h3 style="font-family: 'Lato', sans-serif; font-size: 24px; font-weight: 300;">Welcome On Board , ${firstName},<br/>Feel free to contact any agent on the plaform <P>ENJOY</P> !.</h3>
                                <p><a href= class="btn btn-primary" style="padding: 15px 35px; display: inline-block; border-radius: 3px; background: #7e2e00; color: #ffffff; text-decoration: none;">welcome</a></p>
