...
const {signUp, logIn, update, favoriteProperty, removeFavorite, forgotPassword, resetPassword, logOut, deleteUserAccount, getAll, getOne} = require('../Controller/userController');
...
//add to favorite
router.put('/favoriteProperty/:propertyId',authenticate, favoriteProperty)
//remove From Favourite 
router.post("/removeFavorite/:propertyId", authenticate, removeFavorite)
